  ...
  return (collection == undefined)?<div></div>:(
    <div className={styles.container}>
       <Head>
        ...
        <meta
          name="description"
          content={`Collection ${collection.title} for women at Habaneras de Lino which is an online store specializes in linen and cotton clothes such as guayaberas and guayamisas`}
        />
        ...
        <meta
          ...
          content={`Collection ${collection.title} for women at Habaneras de Lino which is an online store specializes in linen and cotton clothes such as guayaberas and guayamisas`}
        />
        <meta property="og:url" content={`https://habanerasdelino.com/collection/enzo-women/${collection.id}`} />
