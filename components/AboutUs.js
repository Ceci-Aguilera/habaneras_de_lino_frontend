      ...
      <div className={styles.about_div} id="about_store">
        ...
        <div className={styles.about_p_div}>
          <p className={styles.about_p}>
            <strong>Habaneras de Lino</strong> commercializes a Mexican brand
            that offers its customers an experience of comfort, luxury and
            modernity. Initially inspired by the typical Cuban garment: the{" "}
            <strong>guayabera</strong>, it exceeded itself and went beyond this
            culture, while elegantly mixing <strong>linen</strong> and{" "}
            <strong>cotton</strong> with natural and fresh fibers that reminds
            of the Caribbean, and with a touch of originality that makes a
